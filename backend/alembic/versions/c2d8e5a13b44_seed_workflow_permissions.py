"""seed workflow permissions for existing organizations

Revision ID: c2d8e5a13b44
Revises: b1c4d7e92f31
...
revision: str = "c2d8e5a13b44"
down_revision: Union[str, Sequence[str], None] = "b1c4d7e92f31"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

PERMISSIONS: tuple[tuple[str, str, str], ...] = (
    ("Read Workflows", "workflows:read", "View workflow automation definitions"),
    (
        "Write Workflows",
        "workflows:write",
        "Create and update workflow automation definitions",
    ),
    ("Delete Workflows", "workflows:delete", "Delete workflow automation definitions"),
)

ROLE_PERMISSION_SLUGS: dict[str, tuple[str, ...]] = {
    "admin": tuple(permission[1] for permission in PERMISSIONS),
    "manager": ("workflows:read", "workflows:write"),
