...
interface BrowserAutomationAccessDeniedProps {
  title?: string;
  message?: string;
}

export function BrowserAutomationAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view Browser Automation. Contact your organization admin if you need access.",
}: BrowserAutomationAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="blue"
