...
interface CustomerSupportAccessDeniedProps {
  title?: string;
  message?: string;
}

export function CustomerSupportAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view Customer Support tickets. Contact your organization admin if you need access.",
}: CustomerSupportAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="blue"
