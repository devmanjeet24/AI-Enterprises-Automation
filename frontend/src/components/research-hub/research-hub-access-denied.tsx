...
interface ResearchHubAccessDeniedProps {
  title?: string;
  message?: string;
}

export function ResearchHubAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view Research Hub projects. Contact your organization admin if you need access.",
}: ResearchHubAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="purple"
