...
export function ResearchHubCardGridSkeleton() {
  return (
...
export function ResearchHubStatsSkeleton() {
  return (
...
/** Combined loading skeleton for the projects grid section. */
export function ResearchHubSkeleton() {
  return <ResearchHubCardGridSkeleton />;
}

export function ResearchProjectDetailSkeleton() {
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <DashboardCard variant="panel" accent="purple" interactive={false} className="h-96 p-6">
