...
interface AiEmployeesAccessDeniedProps {
  title?: string;
  message?: string;
}

export function AiEmployeesAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view AI Employees. Contact your organization admin if you need access.",
}: AiEmployeesAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="emerald"
