...
interface PermissionsAccessDeniedProps {
  title?: string;
  message?: string;
}

export function PermissionsAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view the permissions catalog. Contact your organization administrator if you need access.",
}: PermissionsAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="neutral"
