...
export function PermissionsCardGridSkeleton() {
  return (
...
export function PermissionsStatsSkeleton() {
  return (
  ...
  return (
    <div className="pb-10 md:pb-12">
      ...
      <div className="mt-10 px-6 md:px-8">
        <PermissionsStatsSkeleton />
      </div>
      <div className="mt-10 px-6 md:px-8">
        <PermissionsCardGridSkeleton />
      </div>
    </div>
  );
}

export function PermissionDetailSkeleton() {
  return (
