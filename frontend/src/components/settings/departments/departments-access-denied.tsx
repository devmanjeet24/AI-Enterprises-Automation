...
interface DepartmentsAccessDeniedProps {
  title?: string;
  message?: string;
}

export function DepartmentsAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view department management. Contact your organization administrator if you need access.",
}: DepartmentsAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="neutral"
