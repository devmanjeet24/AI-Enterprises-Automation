...
interface RolesAccessDeniedProps {
  title?: string;
  message?: string;
}
...
export function RolesAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view role management. Contact your organization administrator if you need access.",
}: RolesAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="neutral"
