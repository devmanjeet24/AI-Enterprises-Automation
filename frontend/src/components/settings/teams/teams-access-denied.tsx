...
export function TeamsAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view org team management. Contact your organization administrator if you need access.",
}: TeamsAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="neutral"
