...
interface WorkflowsAccessDeniedProps {
  title?: string;
  message?: string;
}

export function WorkflowsAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view Workflows. Contact your organization admin if you need access.",
}: WorkflowsAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="purple"
