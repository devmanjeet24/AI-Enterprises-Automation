...
interface AgentTeamsAccessDeniedProps {
  title?: string;
  message?: string;
}

export function AgentTeamsAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view Agent Teams. Contact your organization admin if you need access.",
}: AgentTeamsAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="blue"
