...
interface KnowledgeBaseAccessDeniedProps {
  title?: string;
  message?: string;
}
...
export function KnowledgeBaseAccessDenied({
  title = "Access denied",
  message = "You do not have permission to view the Knowledge Base. Contact your organization admin if you need access.",
}: KnowledgeBaseAccessDeniedProps) {
  return (
    <DashboardCard
      variant="panel"
      accent="purple"
